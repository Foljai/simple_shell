...
/**
 * print_d - function print a decimal (integers) number (bases 10)
 * @input: the input
 * @fd: the filedescriptor to write into
 *
 * Return: num of characters that 
 */
...
/**
 * convert_number - conver function, a clone of its
 * @num: numbers
 * @base: base
 ...
 * @buf: address of the strings to now modify
 *
 * Return: Always 0;
 */
